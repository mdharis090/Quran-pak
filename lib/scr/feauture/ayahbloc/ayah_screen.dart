...
class AyahScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      ...
      child: BlocConsumer<AyahCubit, AyahState>(
        listenWhen: (prev, curr) => prev.audioError != curr.audioError,
        listener: (context, state) {
          if (state.audioError.isNotEmpty) {
            ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(content: Text(state.audioError)),
            );
          }
        },
            ...
            appBar: AppBar(
              ...
              actions: [
                IconButton(
                  ...
                  onPressed: () {
                    _showSettingsModal(
                        context, context.read<AyahCubit>(), state);
                  },
                ),
              ],
            ),
  ...
  Widget _buildBody(BuildContext context, AyahState state, ThemeData theme) {
    if (state.loading) {
      return Center(
        ...
        Expanded(
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              final isPlaying = state.playingKey == key && state.isPlaying;
              final isAudioLoading = state.audioLoadingKey == key;

              final cardColor =
                  state.nightMode ? const Color(0xFF1E1E1E) : Colors.white;
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: TextStyle(
                        fontFamily:
                            'PDMS_IslamicFont', // Use a font references here if available
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    IconButton(
                      onPressed: () {
                        // Optionally add stop/minimize behavior
                      },
                      icon:
  ...
  void _showSettingsModal(
      BuildContext context, AyahCubit cubit, AyahState state) {
